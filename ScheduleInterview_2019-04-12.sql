...
# Generation Time: 2019-04-12 04:33:10 +0000
# ************************************************************
...
INSERT INTO `event_global` (`event_id`, `publisher_id`, `event_name`, `time`, `location`)
VALUES
	(00000001,00000001,'name','2019-01-01','test');
...
INSERT INTO `event_group` (`event_id`, `group_id`, `publisher_id`, `event_name`, `time`, `location`)
VALUES
	(00000001,00000001,00000001,'name','2019-01-01','test');
...
CREATE TABLE `invitation` (
  ...
  UNIQUE KEY `group_id` (`group_id`,`inviter_id`,`invitee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `invitation` WRITE;
/*!40000 ALTER TABLE `invitation` DISABLE KEYS */;

INSERT INTO `invitation` (`invitation_id`, `group_id`, `inviter_id`, `invitee_id`)
VALUES
...
# Dump of table invitation_accept
# ------------------------------------------------------------

DROP TABLE IF EXISTS `invitation_accept`;

CREATE TABLE `invitation_accept` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `invitation_id` int(8) unsigned zerofill NOT NULL,
  `group_id` int(8) unsigned zerofill NOT NULL,
  `user_id` int(8) unsigned zerofill NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `invitation_accept` WRITE;
/*!40000 ALTER TABLE `invitation_accept` DISABLE KEYS */;

INSERT INTO `invitation_accept` (`id`, `invitation_id`, `group_id`, `user_id`)
VALUES
	(1,00000001,00000001,00000006);

/*!40000 ALTER TABLE `invitation_accept` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table invitation_refuse
# ------------------------------------------------------------

DROP TABLE IF EXISTS `invitation_refuse`;

CREATE TABLE `invitation_refuse` (
  `id` int(8) unsigned NOT NULL AUTO_INCREMENT,
  `invitation_id` int(8) unsigned zerofill NOT NULL,
  `group_id` int(8) unsigned zerofill NOT NULL,
  `user_id` int(8) unsigned zerofill NOT NULL,
...
CREATE TABLE `order_global` (
  ...
  UNIQUE KEY `user_id` (`user_id`,`event_id`,`clause_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `order_group` (
  ...
  `clause_id` int(8) unsigned zerofill NOT NULL,
  PRIMARY KEY (`order_id`),
  UNIQUE KEY `user_id` (`user_id`,`group_id`,`event_id`,`clause_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
VALUES
	...
	(00000007,'(userName)','(vo.password)','(vo.phone)',0,'');
